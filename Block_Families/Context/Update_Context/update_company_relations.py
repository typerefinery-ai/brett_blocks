...
def update_company_relations(reln_type=None):
    ...
    Paths["base"]["users"] = TR_Context_Memory_Dir + local["users"]
    Paths["base"]["company"] = TR_Context_Memory_Dir + local["company"]
    Paths["base"]["assets"] = TR_Context_Memory_Dir + local["assets"]
    Paths["base"]["systems"] = TR_Context_Memory_Dir + local["systems"]
    Paths["base"]["relations"] = TR_Context_Memory_Dir + local["relations"]
