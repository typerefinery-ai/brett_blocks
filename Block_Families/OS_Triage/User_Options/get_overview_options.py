...
##############################################################################
# Title: Get Overview Options JSON
# Author: OS-Threat
# Organisation Repo: https://github.com/typerefinery-ai/brett_blocks
# Contact Email: brett@osthreat.com
# Date: 07/08/2023
#
# Description: This script is designed to get the Options JSON for the Overview widget
#
...
def get_overview_options():
    ...
    with open(TR_Settings_Dir + "/options.json", "r") as mem_input:
        ...
        core_overview_options = options.get("overview_options", {})
        colour_options = options.get("colours", {})
        overview_options = core_overview_options | common_options
        if common_options["current_theme"] == "light":
            overview_options["theme"] = colour_options["light_theme"]
        else:
            overview_options["theme"] = colour_options["dark_theme"]

    return overview_options


def main(inputfile, outputfile):


    overview_options = get_overview_options()

    with open(outputfile, "w") as outfile:
        json.dump(overview_options, outfile)
