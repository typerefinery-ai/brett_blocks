...
def make_sro(sro_form, observed_data_refs, where_sighted_refs, sighting_of_ref):
    ...
    if observed_data_refs:
        ...
        for where in observed_data_refs:
            obs_list.append(where["id"])
        contents["where_sighted_refs"] = obs_list
    if sighting_of_ref:
...
def main(inputfile, outputfile):
    ...
    stix_dict = make_sro(sro_form, observed_data_refs, where_sighted_refs, sighting_of_ref)
    results = {}
