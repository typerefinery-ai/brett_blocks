...
def try_import_bundle():
    import_bundle({"connection": connection, "url": report_url}, "output1.json", logger)
...
def try_get_object():
    ...
    get_object({"connection": connection, "stix_id": report_id}, "output2.json", logger)
...
def try_get_embedded():
    ...
    get_embedded({"connection": connection, "stix_object": report_dict}, "output3.json", logger)
